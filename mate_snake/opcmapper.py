...
def find_led_number_for_x_and_y_value(x, y):
    ...
    y = ((11-y)/transform_factor) # yet another correction... zero point of y axis in game code is at the top left
